namespace Cultivo.Domain.Constants
{
    public static class Validators
    {
        ...
        public const string MESSAGE_LASTNAME_EMPTY = "O sobrenome não pode ficar vazio. Por favor, insira um sobrenome.";
        ...
        public const string MESSAGE_LASTNAME_NULL = "Por favor, insira um sobrenome.";
